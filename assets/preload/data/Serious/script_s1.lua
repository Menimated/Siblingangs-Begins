...
function onEvent(name, value1, value2)
	...
	elseif (name == 'dialogue.step' and value1 == 'w1a1d1' and value2 == '4') then
		playMusic('nothing', 0, true);
		soundFadeIn('', 2);
	elseif (name == 'dialogue.step' and value1 == 'w1a1d1' and value2 == '5') then
		playMusic('bambicutscene', 3, true);
	end
end
