...
local songdata = {
    ...
    ['Killer Scream'] = {
    'Killer Scream', -- Song Name [1]
    'GGalactigal', -- Composer [2]
...
function onSongStart()
 ...
 if songExists == true then
    ...
    setTextString('creditCreator', "Original song by: "..curSongTable[2])

    --Tweens--
    doTweenX("creditBoxTween", "creditBox", getProperty("creditBox.x") + objWidth, 1, "elasticOut")
    doTweenX("creditTitleTween", "creditTitle", getProperty("creditTitle.x") + objWidth, 1, "elasticOut")
    doTweenX("creditCreatorTween", "creditCreator", getProperty("creditCreator.x") + objWidth, 1, "elasticOut")
...
function onTimerCompleted(timerName)
    ...
    if timerName == "creditDisplay" then
        doTweenX("creditBoxTween", "creditBox", getProperty("creditBox.x") - objWidth, 0.5, "elasticIn")
        doTweenX("creditTitleTween", "creditTitle", getProperty("creditTitle.x") - objWidth, 0.5, "elasticIn")
        doTweenX("creditCreatorTween", "creditCreator", getProperty("creditCreator.x") - objWidth, 0.5, "elasticIn")
