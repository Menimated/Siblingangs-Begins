...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Onii-chan!!!",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["Damn, Zuki kinda zuz",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
		["Imagine Haruki doesn't like justin bieber",			"Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			false],
		["Cat girl",					"Beat Week 4 on Hard with no Misses.",				'week4_nomiss',			false],
		["THE POWER OF UNFAIRNESS",			"Beat Week 5 on Hard with no Misses.",				'week5_nomiss',			false],
