...
class FreeplayDNBState extends MusicBeatState
{
	var songs:Array<SongMetadataDNB> = [];
	...
	{
		addSong('New Here', 4, 'dave', FlxColor.BLUE);
		addSong('Showtime', 4, 'dave', FlxColor.BLUE);
		addSong('Serious', 4, 'bambi', FlxColor.LIME);
		addSong('Freaking out', 4, 'bambi3d', FlxColor.GREEN);
		...
		bg = new FlxSprite().loadGraphic(Paths.image('menuDNB'));
	...
	{
		songs.push(new SongMetadataDNB(songName, weekNum, songCharacter, color));
	}
