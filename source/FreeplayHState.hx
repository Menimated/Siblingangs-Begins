...
class FreeplayHState extends MusicBeatState
{
	var songs:Array<SongMetadataH> = [];
	...
	{
		addSong('Unsurvivable', 7, 'trueex', FlxColor.BLUE);
		...
		#if PRELOAD_ALL
		var leText:String = "YOU'RE FUCKED";
		var size:Int = 16;
		#else
		var leText:String = "YOU'RE FUCKED";
		var size:Int = 18;
	...
	{
		songs.push(new SongMetadataH(songName, weekNum, songCharacter, color));
	}
	...
	override function update(elapsed:Float)
	{
		...
		else #end if (accepted && haventselected)
		{
			...
			var llll = FlxG.sound.play(Paths.sound('confirmMenuH')).length;
			...
			new FlxTimer().start(2, function(tmr:FlxTimer)
				{
					...
					PlatformUtil.sendFakeMsgBox("JUST TO TELL YOU THIS, IF YOU DIED, YOU CAN'T RESTART THE HARDCORE SONG! MUAHAHAHAHAHAHA!");
	...
	function changeDiff(change:Int = 0)
	{
		...
		PlayState.storyDifficulty = curDifficulty;
		diffText.text = 'HARDCORE ONLY';
		positionHighscore();
	}

	function changeSelection(change:Int = 0, playSound:Bool = true)
	{
		if(playSound) FlxG.sound.play(Paths.sound('scrollMenuH'), 0.4);
